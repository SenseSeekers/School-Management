                    ...
                    <div class="blog-sidebar right">
                        ...
                        ?>
                            <div class="single-blog-banner">
                                <a href="<?php echo base_url('index.php/Front/Citizen_blog/');?><?php echo $CitizenData->id;?>" id="blog"><img src="<?php echo base_url();?>images/citizen/<?php echo $CitizenData->image;?>" alt="blog"></a>
                        ...
                        ?>
                            <div class="single-post">
                                <div class="single-post-img" style="width:30%;">
                                    <a href="<?php echo base_url('index.php/Front/Citizen_blog/');?><?php echo $CitizenData->id;?>"><img src="<?php echo base_url();?>images/citizen/<?php echo $CitizenData->image;?>" alt="post" style="width:100%;">

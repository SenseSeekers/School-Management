					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="<?php echo base_url('index.php/User/Alluser/');?>">User </a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">User All</li>
							</ol>
						</div>
					</div>
					<div class="row">
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="<?php echo base_url('index.php/GaiUser/Adduser/');?>" id="addRow"
																		class="btn btn-info">

													...
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															...
															<div class="profile-usertitle">
																<div class="doctor-name"><?php echo $CurriculumData->curri_id;?></div>
															</div>
															<div class="btn-group">
								
															<a href="<?php echo base_url('index.php/Auth/EditSlider/');?><?php echo $CurriculumData->id;?>" type="button" class="btn btn-primary"><i class="fa fa-edit"></i></a>
															<!-------------------------------------------->	

				...
				<div class="page-content">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Curriculum Edit</div>
							</div>
					...
					<div class="container">
						...
						<form action="<?php echo base_url('index.php/Auth/editCurriculum/');?>" method="post" >
							<div class="row">
							<div class="col-md-12 col-sm-12">
								<input type="hidden" name="id" class="form-control" value="<?php echo $curridata->id;?>">
								<div class="form-group">
									<label for="name">Curriculum Menu Name </label>
									<input type="text" name="name" class="form-control" value="<?php echo $curridata->name;?>">
								</div>
							</div>	
							</div>
															...
															<table
																...
																?>
																	...
																	<tr class="odd gradeX">
																		...
																		<td>
																			<a href="<?php echo base_url('index.php/Auth/ImportantLinkEdit/'); ?><?php echo $CurriData->id; ?>" class="btn btn-warning btn-xs">Edit</a>

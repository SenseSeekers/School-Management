			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="container">
						...
						<form action="<?php echo base_url('index.php/Auth/writeImpLink/');?>" method="post" >
							<div class="row">
							<div class="col-md-8 col-sm-8">
								<div class="form-group">
									<label for="title">Site Title</label>
									<input type="text" name="title" class="form-control" placeholder="Site Title">
								</div>
								<div class="form-group">
									<label for="title">Site Link</label>
									<input type="text" name="link" class="form-control" placeholder="Enter Site Link">
								</div>
							</div>	
							</div>

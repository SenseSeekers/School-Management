						...
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Dashboard
									<!--<?php 
										if($userData->firstname == '' OR $userData->lastname=='' OR $userData->image=='' OR $userData->phone=='' OR $userData->department=='' OR $userData->designation==''){
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="<?php echo base_url();?>index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-green">
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><?php if(isset($TotalStudent)){ echo $TotalStudent; }else{ echo '0'; } ?></span>
							...
							<div class="col-xl-3 col-md-6 col-12">
								<div class="info-box bg-b-blue">
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><?php if(isset($Totalcourse)){ echo $Totalcourse; }else{ echo '0'; } ?></span>
										<div class="progress">
										</div>
										<span class="progress-description">
										</span>
						...
						<div class="col-sm-8">
							<div class="card card-box">
								<div class="card-head">
									...
									<div class="tools">
										<a class="fa fa-repeat btn-color box-refresh" href="<?php echo base_url();?>javascript:;"></a>
										<a class="t-collapse btn-color fa fa-chevron-down" href="<?php echo base_url();?>javascript:;"></a>
										<a class="t-close btn-color fa fa-times" href="<?php echo base_url();?>javascript:;"></a>
									</div>
								</div>
			...
			<div class="chat-sidebar-container" data-close-on-body-click="false">
				<div class="chat-sidebar">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="<?php echo base_url();?>#quick_sidebar_tab_1" class="nav-link active tab-icon" data-toggle="tab"> <i
									class="material-icons">chat</i>Chat
								<span class="badge badge-danger">4</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?php echo base_url();?>#quick_sidebar_tab_3" class="nav-link tab-icon" data-toggle="tab"> <i

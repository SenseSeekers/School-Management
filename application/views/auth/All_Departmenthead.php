				...
				<div class="page-content">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Department Head List</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Department Head List</li>
							</ol>
						</div>
					</div>
					<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All DepartmentHead</header>
														<div class="tools">
...
?>
																	<tr class="odd gradeX">
																		...
																		<td>
																			<?php if($FacultyData->principal == 1){ ?>
																			<a href="#" class="btn btn-primary btn-xs">P</a>
																			<?php 	}else{ ?><a href="<?php echo base_url('index.php/Auth/Principal/'); ?><?php echo $FacultyData->id; ?>" class="btn btn-default btn-xs">P</a><?php }	?>

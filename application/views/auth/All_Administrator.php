				...
				<div class="page-content">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Administrator Head List</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Administrator Head List</li>
							</ol>
						</div>
					</div>
					<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All AdministratorHead</header>
														<div class="tools">
...
<!-------------------------------------------------------------------->
																...
																?>
<?php 
 if($FacultyData->type == 'Administrator'){
?>
																	<tr class="odd gradeX">
																		<td class="patient-img">
